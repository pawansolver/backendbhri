...
router.post('/', protect, controller.createSlot);
router.post('/add-custom-bulk', protect, controller.createCustomSlotsBulk);
router.post('/generate', protect, controller.generateSlots);
router.post('/generate-bulk', protect, controller.generateBulkSlots);
